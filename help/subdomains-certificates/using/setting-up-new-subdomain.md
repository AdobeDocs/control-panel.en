...
This page provides information on how to set up new subdomains using the setup methods below:

* Full subdomain delegation,
* Subdomain delegation using CNAMEs.

Global concepts on these two methods are presented in this section: [](../../subdomains-certificates/using/subdomains-branding.md).
...
Control Panel allows you to delegate a subdomain to Adobe Campaign using CNAMEs. To do this, follow these steps:
