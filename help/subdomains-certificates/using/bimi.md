...
1. The **[!UICONTROL Selector]** field allows you to specificy a BIMI selector for the record. A BIMI selector is a unique identifier that you can assign to a record. This allows you to define multiple logos for a given subdomain.
